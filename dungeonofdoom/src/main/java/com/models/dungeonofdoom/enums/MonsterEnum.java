...
public enum MonsterEnum {
     ...
     */
    AQUATOR('A', "Aquator", 0, "M",  20, 5, 9, new Pair<>(5,8), new Pair<>(5,0), Arrays.asList(new Pair<>(0,0))),
    ...
    DRAGON('D', "Dragon", 100,  "M", 6800, 10, 1, new Pair<>(10, 8), new Pair<>(10,0), Arrays.asList(new Pair<>(1,8),new Pair<>(1,8),new Pair<>(3,10))),
    EMU('E', "Emu", 0, "M", 2, 1, 10, new Pair<>(1,8), new Pair<>(1,4), Arrays.asList(new Pair<>(1,2))),
    VENUSFLYTRAP('F', "Venus Flytrap", 0, "M", 80, 8, 3, new Pair<>(8,8), new Pair<>(8,0), Arrays.asList(new Pair<>(0,0))),
    GRIFFON('G', "Griffon", 20, "MFR", 2000, 13, -2, new Pair<>(13,8), new Pair<>(13,0), Arrays.asList(new Pair<>(4,3), new Pair<>(2,5), new Pair<>(4,3))),
    ...
    JABBERWOCK('J', "Jabberwock", 70, "", 4000, 15, -4, new Pair<>(16,8), new Pair<>(15,0), Arrays.asList(new Pair<>(2,12), new Pair<>(2,4))),
    ...
    MEDUSA('M', "Medusa", 40, "M", 200, 8, 9, new Pair<>(8,8), new Pair<>(8,0), Arrays.asList(new Pair<>(3,4), new Pair<>(3,4), new Pair<>(2,5))),
    NYMPH('N', "Nymph", 100, "", 37, 3, 2, new Pair<>(3, 8), new Pair<>(3,0), Arrays.asList(new Pair<>(0,0))),
    ORC('O', "Orc", 15, "G", 5, 1, 5, new Pair<>(1,8), new Pair<>(3,6), Arrays.asList(new Pair<>(1,8))),
    PHANTOM('P', "Phantom", 0, "I", 120, 8, 8 , new Pair<>(8,8), new Pair<>(8,0), Arrays.asList(new Pair<>(4,4))),
    QUAGGA('Q', "Quagga", 30, "M", 32, 3, 9, new Pair<>(3,8), new Pair<>(3,0), Arrays.asList(new Pair<>(1,2), new Pair<>(1,2), new Pair<>(1,4))),
    ...
    TROLL('T', "Troll", 50, "RM", 120, 6, 7, new Pair<>(6,8), new Pair<>(6,0), Arrays.asList(new Pair<>(1,8), new Pair<>(1,8), new Pair<>(2,6))),
    URVILLE('U', "Ur-vile", 0, "M", 190, 7, 13, new Pair<>(7,8), new Pair<>(7,0), Arrays.asList(new Pair<>(1,3), new Pair<>(1,3), new Pair<>(1,3), new Pair<>(4,6))),
    VAMPIRE('V', "Vampire", 20, "RM", 350, 8, 10, new Pair<>(8,8), new Pair<>(8,0), Arrays.asList(new Pair<>(1,10))),
    WRAITH('W', "Wraith", 0 , "", 55, 5, 7, new Pair<>(5,8), new Pair<>(5,0), Arrays.asList(new Pair<>(1,6))),
    XEROC('X', "Xeroc", 30, "", 100, 7, 4, new Pair<>(7,8), new Pair<>(7,0), Arrays.asList(new Pair<>(3,4))),
    YETI('Y', "Yeti", 30, "", 50, 4,5, new Pair<>(4,8), new Pair<>(4,0), Arrays.asList(new Pair<>(1,6), new Pair<>(1,6))),
